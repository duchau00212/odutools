...
def set_password(input_file, user_pass):
    """
    ...
    input_stream = PdfFileReader(open(input_file, "rb"))
    ...
    try:
        ...
        _logger.error('Error when trying to remove file %s' % input_file)
                

    # Rename temporary output file with original filename, this
    # will automatically delete temporary fileư
...
class Report(models.Model):
    ...
    @api.model
    def _run_wkhtmltopdf_enscript(self, headers, footers, bodies, landscape, paperformat, spec_paperformat_args=None, save_in_attachment=None, set_viewport_size=False, password=False ):
        ...
        """
        if not password:
            return self._run_wkhtmltopdf(headers, footers, bodies, landscape, paperformat, spec_paperformat_args=spec_paperformat_args, save_in_attachment=save_in_attachment, set_viewport_size=set_viewport_size  )
        ...
        #enscript.
        entire_report_path = set_password(entire_report_path, password )
    ...
    @api.model
    def get_pdf_enscript(self, docids, report_name, html=None, data=None, password=False ):
        ...
        if not password:
            return self.get_pdf (docids, report_name, html=html, data=data )
        ...
        return self._run_wkhtmltopdf_enscript(
            headerhtml, footerhtml, contenthtml, context.get('landscape'),
            paperformat, specific_paperformat_args, save_in_attachment,
            context.get('set_viewport_size'), password=password
        )
    ...
    def get_pdf(self, docids, report_name, html=None, data=None):
        ...
        if password:
            return self.get_pdf_enscript(docids, report_name, html=html, data=data, password=password )
        else:
